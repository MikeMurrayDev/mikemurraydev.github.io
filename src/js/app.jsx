...
class App extends Component {
    ...
    componentDidMount () {
      ...
      for (let i = 0; i < projectData.length; i++) {
          projectData[i].ref = refArray[i];
          console.log(projectData[i]);
          console.log(refArray);
      }
      this.setState({projectsArray: projectData})
      // console.log(this.state.projectsArray);
  };
      ...
      return (
          <>
              <div className="contact-container">
                  <div className="each-contact"><a href="https://www.linkedin.com/in/mikemurraydev/" target="_blank" title="LinkedIn" className="linkedin" ><FaLinkedinIn /></a></div>
                  <div className="each-contact"><a href="mailto:mikemurraydev@gmail.com" target="_blank" title="email" className="email" ><FaEnvelopeSquare /></a></div>
                  <div className="each-contact"><a href="https://github.com/mikemurraydev?tab=repositories" target="_blank" title="github-top" className="github-top" ><FaGithubSquare /></a></div>
              ...
              <div className="flex-container-vertical">
                  ...
                  <h1 className="name-text">Hello, I'm <span id="mike">Mike</span>. I'm a Fullstack Developer living in San Diego.</h1>
              </div>
              ...
              <div className={ this.isArrow() }></div>
              {
                  this.state.visibleArray.map((each) => {
                      return(         
                              <div className="project-visibility-container" id={ each.key } key={ each.key } ref={ each.ref }>
